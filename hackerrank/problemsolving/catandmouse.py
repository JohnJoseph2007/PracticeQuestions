...
# cats travel at equal speed. If the cats arrive at the same time, the mouse will be allowed to move
...
# and for mouse C. Complete the function catAndMouse to return the appropriate answer to each query, which 
