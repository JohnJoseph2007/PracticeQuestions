...
def plusMinus(arr):
    ...
    for i in arr:
        if i>0:
            ...
            neg+=1
    pospercent = pos/length
    negpercent = neg/length
    zeropercent = zero/length
    print("{0:.6f}".format(pospercent))
    print("{0:.6f}".format(negpercent))
    print("{0:.6f}".format(zeropercent))    

n = int(input().strip())
arr = list(map(int, input().rstrip().split()))
plusMinus(arr)

# This is how to add precision control to your decimals:
# print("{0:.6f}".format(x)) 
